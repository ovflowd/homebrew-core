class Dolphie < Formula
  ...
  resource "tree-sitter" do
    ...
    # paatch to replace usage of private function, upstream bug report, https://github.com/tree-sitter/py-tree-sitter/issues/300
    patch do
      url "https://github.com/tree-sitter/py-tree-sitter/commit/2f7889dec37f314dcfb1f34253d5a6740c9ef510.patch?full_index=1"
      sha256 "5f5496982f7a186428b46c57ca9bcf8120614915818946fed6cffdb3acf2da57"
    end
  end
